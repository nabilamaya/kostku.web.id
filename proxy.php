...
// Mengecek apakah host adalah salah satu yang diperbolehkan
$allowedHosts = ['owner.kostku.web.id', 'kostku.web.id'];
if (!in_array($parsedUrl['host'], $allowedHosts)) {
    echo 'Akses ditolak. Hanya URL dari owner.kostku.web.id atau kostku.web.id yang diperbolehkan.';
    exit;
}
